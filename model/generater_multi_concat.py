...
class SequenceGeneratorModel(nn.Module):
    ...
    def forward(self, src_tokens,image_feature, tgt_tokens, src_seq_len=None, tgt_seq_len=None, first=None,object_names=None,obj_lens=None,rel_adjs=None,rel_lens=None,rel_trips=None,trip_lens=None):
        """
        ...
        :return:
        """
        return self.seq2seq_model(src_tokens, image_feature,tgt_tokens, src_seq_len, tgt_seq_len, first,object_names,obj_lens,rel_adjs,rel_lens,rel_trips,trip_lens)

    def predict(self, src_tokens, image_feature,src_seq_len=None, first=None,object_names=None,obj_lens=None,rel_adjs=None,rel_lens=None,rel_trips=None,trip_lens=None):
        """
        ...
        :return:
        """
        img_feat_, state,_ = self.seq2seq_model.prepare_state(src_tokens, image_feature, src_seq_len, first,None,object_names,obj_lens,rel_adjs,rel_lens,rel_trips,trip_lens)
